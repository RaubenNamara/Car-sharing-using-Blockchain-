            ...
            <div className="body-form">
              <form onSubmit={handleSubmit}>
                ...
                <div className="input-group mb-3" >
                  <input type="text" className="form-control" placeholder="Email" ref={emailRef} id="email" style={{ border: "4px solid #037fff", backgroundColor: '#ffffff', boxShadow: "0 0 3px 2px #037fff", borderRadius: "9px", width: '35rem', paddingTop: '20px', paddingBottom: '18px', paddingLeft: '7px', marginTop: '45px', marginLeft: '45px', marginRight: '10px' }} />
                  <span className="input-group-text" id="basic-addon2" style={{ fontSize: '40px' }}>@drivercryptridez.com</span>
                </div>
